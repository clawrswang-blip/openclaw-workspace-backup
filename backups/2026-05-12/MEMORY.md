...
| **Team SFC Rules 草稿** | **Franco+Rishon 负责，本周完成** | `memory/projects/sfc-team-rules-draft.md` |
...
**每次 coding 操作前：**
1. 先加载 `karpathy-coding-principles` skill
2. 结合其他实际执行 coding 的 skill（coding-agent / frontend-design 等）
3. 应用 4 大原则：Think Before Coding → Simplicity First → Surgical Changes → Goal-Driven Execution
