...
<!-- openclaw-memory-promotion:memory:memory/2026-07-08.md:23:26 -->
- cangjie-skill 安装: **核心能力**:; 把书/视频/播客/课程的方法论 → 可执行 agent skills; 5个 sub-agent 并行提取（框架/原则/案例/反例/术语）; 三重验证筛选（跨域佐证/预测力/独特性） [score=0.857 recalls=0 avg=0.620 source=memory/2026-07-08.md:23-26]
<!-- openclaw-memory-promotion:memory:memory/2026-07-08.md:19:22 -->
- cangjie-skill 安装: **时间**: 2026-07-08 10:41 PDT; **来源**: https://github.com/kangarooking/cangjie-skill; **安装路径**: `~/.openclaw/workspace/skills/cangjie-skill/`; **触发关键词**: 蒸馏、拆书、把xx做成skill、distill book into skills [score=0.857 recalls=0 avg=0.620 source=memory/2026-07-08.md:19-22]
<!-- openclaw-memory-promotion:memory:memory/2026-07-08.md:27:29 -->
- cangjie-skill 安装: RIA++ 构造 skill（R原话/I重写/A1案例/A2触发/E执行/B边界）; Zettelkasten 链接 + 压力测试 + DIGEST 精华长文; **生态**: nuwa-skill（人）+ cangjie-skill（书）+ darwin-skill（进化） [score=0.857 recalls=0 avg=0.620 source=memory/2026-07-08.md:27-29]
